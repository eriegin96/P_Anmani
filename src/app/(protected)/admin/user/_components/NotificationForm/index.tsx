...
export default function NotificationForm({id}: TNotificationFormProps) {
	...
	useEffect(() => {
		const fieldsValue = notificationList.find((noti) => noti.id === id);
		form.setFieldsValue({
			...fieldsValue,
