...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 18736)), "/home/eriegin/workplace/P_Anmani/src/app/(site)/page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87393)), "/home/eriegin/workplace/P_Anmani/src/app/error.tsx"],
    ...
    const pages = ["/home/eriegin/workplace/P_Anmani/src/app/(site)/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 94208))
...
// EXTERNAL MODULE: ./src/app/(site)/page.module.scss
var page_module = __webpack_require__(50383);
var page_module_default = /*#__PURE__*/__webpack_require__.n(page_module);
// EXTERNAL MODULE: ./src/app/(site)/_components/index.ts + 20 modules
var _components = __webpack_require__(19892);
...
;// CONCATENATED MODULE: ./src/app/(site)/static.tsx
...
const locationList = [
    {
        value: route/* QUERY_PARAMS */.Tx.LOCATION.HCM,
        name: "Hồ Ch\xed Minh"
    },
    {
        value: route/* QUERY_PARAMS */.Tx.LOCATION.NHA_TRANG,
        name: "Nha Trang"
    },
    {
        value: route/* QUERY_PARAMS */.Tx.LOCATION.PHU_QUOC,
        name: "Ph\xfa Quốc"
    },
    {
        value: route/* QUERY_PARAMS */.Tx.LOCATION.DA_NANG,
        name: "Đ\xe0 Nẵng"
    }
];
const categoryList = [
    {
        id: "1",
        type: route/* QUERY_PARAMS */.Tx.TYPE.SINGLE,
        title: product/* PRODUCT_TYPE */.fY.SINGLE_VILLA,
        location: locationList,
        href: `${route/* ROUTE */.ln.ADVANCED_SEARCH}?type=${route/* QUERY_PARAMS */.Tx.TYPE.SINGLE}`,
        icon: assets/* IconDonLap */.$p
    },
    {
        id: "2",
        type: route/* QUERY_PARAMS */.Tx.TYPE.DOUBLE,
        title: product/* PRODUCT_TYPE */.fY.DOUBLE_VILLA,
        location: locationList,
        href: `${route/* ROUTE */.ln.ADVANCED_SEARCH}?type=${route/* QUERY_PARAMS */.Tx.TYPE.DOUBLE}`,
        icon: assets/* IconSongLap */.VW
    },
    {
        id: "3",
        type: route/* QUERY_PARAMS */.Tx.TYPE.SHOPHOUSE,
        title: product/* PRODUCT_TYPE */.fY.SHOPHOUSE,
        location: locationList,
        href: `${route/* ROUTE */.ln.ADVANCED_SEARCH}?type=${route/* QUERY_PARAMS */.Tx.TYPE.SHOPHOUSE}`,
        icon: assets/* IconCanHo */.Zg
    },
    {
        id: "4",
        type: route/* QUERY_PARAMS */.Tx.TYPE.APARTMENT,
        title: product/* PRODUCT_TYPE */.fY.APARTMENT,
        location: locationList,
        href: `${route/* ROUTE */.ln.ADVANCED_SEARCH}?type=${route/* QUERY_PARAMS */.Tx.TYPE.APARTMENT}`,
        icon: assets/* IconShopHouse */.bT
    },
    {
        id: "5",
        type: route/* QUERY_PARAMS */.Tx.TAG.TRANSFER,
        title: product/* PRODUCT_TAG */.dW.TRANSFER,
        location: locationList,
        href: `${route/* ROUTE */.ln.ADVANCED_SEARCH}?tag=${route/* QUERY_PARAMS */.Tx.TAG.TRANSFER}`,
        icon: assets/* IconTrendingUp */.Wl
    }
];
const investorList = [
    {
...
;// CONCATENATED MODULE: ./src/app/(site)/page.tsx
...
async function Page() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(_components/* AdvancedSearch */.ZJ, {}),
            /*#__PURE__*/ jsx_runtime_.jsx(_components/* NavLinks */.H9, {}),
            /*#__PURE__*/ jsx_runtime_.jsx(_components/* Carousel */.lr, {
                children: carouselList.map((image)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: (page_module_default()).blockWrapper,
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(_components/* Reports */.Aq, {}),
                    /*#__PURE__*/ jsx_runtime_.jsx(_components/* Vouchers */.$4, {}),
                    /*#__PURE__*/ jsx_runtime_.jsx(_components/* FlashSale */.X9, {}),
                    categoryList.map((category)=>/*#__PURE__*/ jsx_runtime_.jsx(_components/* Category */.WD, {
                            category: category
                        }, category.id)),
                    investorList.map((investor)=>/*#__PURE__*/ jsx_runtime_.jsx(_components/* Investor */.jI, {
                            investor: investor
                        }, investor.id)),
                    /*#__PURE__*/ jsx_runtime_.jsx(_components/* HowTo */.K_, {}),
                    /*#__PURE__*/ jsx_runtime_.jsx(_components/* TiktokReview */.Az, {}),
                    /*#__PURE__*/ jsx_runtime_.jsx(_components/* Deposit */.z5, {}),
                    /*#__PURE__*/ jsx_runtime_.jsx(_components/* PersonalInfo */.BS, {}),
                    /*#__PURE__*/ jsx_runtime_.jsx(_components/* Connection */.ew, {})
                ]
            })
        ]
    });
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/eriegin/workplace/P_Anmani/src/app/(site)/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,8308,8300,5776,6154,9892], () => (__webpack_exec__(13503)));
