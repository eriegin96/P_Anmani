...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 93398)), "/home/eriegin/workplace/P_Anmani/src/app/(site)/(auth)/dang-ky/page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87393)), "/home/eriegin/workplace/P_Anmani/src/app/error.tsx"],
    ...
    const pages = ["/home/eriegin/workplace/P_Anmani/src/app/(site)/(auth)/dang-ky/page.tsx"];
    ...
    const originalPathname = "/(site)/(auth)/dang-ky/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 78290))
...
// EXTERNAL MODULE: ./src/app/(site)/(auth)/_components/auth.module.scss
var auth_module = __webpack_require__(39104);
...
;// CONCATENATED MODULE: ./src/hooks/api/auth/mutation/useSignUp.ts



const fetcher = (url, { arg })=>axios/* axiosInstance */.b.post(url, JSON.stringify(arg)).then((res)=>res);
const useSignUp = ()=>{
    const { data, trigger, isMutating, error } = (0,dist/* default */.Z)(api/* API_ENDPOINT */.QP.SIGN_UP, fetcher);
    return {
        trigger,
        isMutating,
        error
...
;// CONCATENATED MODULE: ./src/app/(site)/(auth)/_components/SignUpForm/index.tsx
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(lib/* Form */.l0, {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("h3", {
                className: (auth_module_default()).formTitle,
                children: "Đăng k\xfd"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(lib/* Form */.l0.Item, {
                ...
                className: (auth_module_default()).formItem,
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(lib/* Form */.l0.Item, {
                ...
                className: (auth_module_default()).formItem,
                children: /*#__PURE__*/ jsx_runtime_.jsx(lib.Input, {
                    placeholder: common/* PLACEHOLDER_EMAIL */.jw
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(lib/* Form */.l0.Item, {
                name: "password",
                ...
                className: (auth_module_default()).formItem,
                children: /*#__PURE__*/ jsx_runtime_.jsx(lib.Input.Password, {
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(lib/* Form */.l0.Item, {
                children: /*#__PURE__*/ jsx_runtime_.jsx(lib/* Button */.zx, {
                    ...
                    htmlType: "submit",
                    loading: isMutating,
                    className: (auth_module_default()).btn,
                    children: "Đăng k\xfd"
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (auth_module_default()).footerWrapper,
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("span", {
                    className: (auth_module_default()).text,
                    children: [
...
const proxy = (0,module_proxy.createProxy)(String.raw`/home/eriegin/workplace/P_Anmani/src/app/(site)/(auth)/_components/SignUpForm/index.tsx`)
...
;// CONCATENATED MODULE: ./src/app/(site)/(auth)/dang-ky/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [381,8308,5776,6154,9468], () => (__webpack_exec__(10622)));
