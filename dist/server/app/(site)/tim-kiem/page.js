...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 75865)), "/home/eriegin/workplace/P_Anmani/src/app/(site)/tim-kiem/page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87393)), "/home/eriegin/workplace/P_Anmani/src/app/error.tsx"],
    ...
    const pages = ["/home/eriegin/workplace/P_Anmani/src/app/(site)/tim-kiem/page.tsx"];
    ...
    const originalPathname = "/(site)/tim-kiem/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 71163))
...
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(2318);
/* harmony import */ var _constants_selectOptions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68994);
...
/* harmony import */ var _constants_common__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(89439);
/* harmony import */ var _mock_data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(28313);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(19892);
/* harmony import */ var _timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(94272);
/* harmony import */ var _timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _utils_formatCurrency__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(28970);
...
function Page() {
    ...
    const [searchBoxValue, setSearchBoxValue] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)("");
    const formatter = (value)=>{
        return (0,_utils_formatCurrency__WEBPACK_IMPORTED_MODULE_7__/* .formatCurrency */ .x)(value, true);
    };
    const handleChange = (value)=>{
        console.log(`selected ${value}`);
    };
    const selectList = (0,react__WEBPACK_IMPORTED_MODULE_4__.useMemo)(()=>[
            {
                placeholder: "Ph\xe2n loại",
                value: searchParams.get("tag") || null,
                onChange: handleChange,
                options: _constants_selectOptions__WEBPACK_IMPORTED_MODULE_2__/* .tagOptions */ .hD
            },
            {
                placeholder: "Loại h\xecnh",
                value: searchParams.get("type") || null,
                onChange: handleChange,
                options: _constants_selectOptions__WEBPACK_IMPORTED_MODULE_2__/* .typeOptions */ .mS
            },
            {
                placeholder: "Khu vực",
                value: searchParams.get("location") || null,
                onChange: handleChange,
                options: _constants_selectOptions__WEBPACK_IMPORTED_MODULE_2__/* .locationOptions */ .Z$
            },
            {
                placeholder: "Chủ đầu tư",
                value: searchParams.get("investor") || null,
                onChange: handleChange,
                options: _constants_selectOptions__WEBPACK_IMPORTED_MODULE_2__/* .investorOptions */ .Cd
            },
            {
                placeholder: "Sắp xếp",
                value: null,
                onChange: handleChange,
                options: _constants_selectOptions__WEBPACK_IMPORTED_MODULE_2__/* .sortOptions */ .Fo
            }
        ], [
        searchParams
    ]);
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: (_timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8___default().wrapper),
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components__WEBPACK_IMPORTED_MODULE_1__/* .SearchBox */ .Rj, {
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .X2, {
                ...
                className: (_timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8___default().filterList),
                children: [
                    selectList.map(({ placeholder, value, onChange, options })=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_9__/* .Col */ .JX, {
                            xs: 24,
                            sm: 12,
                            md: 8,
                            lg: 6,
                            xxl: 4,
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_9__/* .Select */ .Ph, {
                                placeholder: placeholder,
                                defaultValue: value,
                                onChange: onChange,
                                options: options,
                                className: (_timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8___default().filterItem)
                            })
                        }, placeholder)),
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_9__/* .Col */ .JX, {
                        ...
                        lg: 6,
                        xxl: 4,
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_9__/* .Button */ .zx, {
                            type: "primary",
                            className: (_timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8___default().filterItem),
                            children: "\xc1p dụng"
                        })
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_9__/* .Slider */ .iR, {
                range: true,
                min: _constants_common__WEBPACK_IMPORTED_MODULE_10__/* .MIN_PRICE */ .fX,
                max: _constants_common__WEBPACK_IMPORTED_MODULE_10__/* .MAX_PRICE */ .y2,
                marks: {
                    [_constants_common__WEBPACK_IMPORTED_MODULE_10__/* .MIN_PRICE */ .fX]: (0,_utils_formatCurrency__WEBPACK_IMPORTED_MODULE_7__/* .formatCurrency */ .x)(_constants_common__WEBPACK_IMPORTED_MODULE_10__/* .MIN_PRICE */ .fX),
                    [_constants_common__WEBPACK_IMPORTED_MODULE_10__/* .MAX_PRICE */ .y2]: (0,_utils_formatCurrency__WEBPACK_IMPORTED_MODULE_7__/* .formatCurrency */ .x)(_constants_common__WEBPACK_IMPORTED_MODULE_10__/* .MAX_PRICE */ .y2)
                },
                defaultValue: [
                    _constants_common__WEBPACK_IMPORTED_MODULE_10__/* .MIN_PRICE */ .fX,
                    _constants_common__WEBPACK_IMPORTED_MODULE_10__/* .MAX_PRICE */ .y2
                ],
                step: 100000000,
                tooltip: {
                    formatter
                },
                className: (_timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8___default().slider)
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_9__/* .Divider */ .iz, {
                className: (_timKiem_module_scss__WEBPACK_IMPORTED_MODULE_8___default().divider)
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_9__/* .Row */ .X2, {
                gutter: [
                    16,
                    16
                ],
                children: _mock_data__WEBPACK_IMPORTED_MODULE_5__/* .productList */ .Uu.map((product)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_9__/* .Col */ .JX, {
                        xs: 24,
                        sm: 12,
                        md: 8,
                        lg: 6,
                        xxl: 4,
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components__WEBPACK_IMPORTED_MODULE_6__/* .ProductCard */ .Il, {
                            info: product
                        })
                    }, product.id))
            })
...
// Exports
module.exports = {
	"wrapper": "timKiem_wrapper__LiExj",
	"filterList": "timKiem_filterList__ABFLV",
	"filterItem": "timKiem_filterItem__zpVzE",
	"slider": "timKiem_slider__7DbOF",
	"divider": "timKiem_divider__gYx_o",
	"overlayShow": "timKiem_overlayShow__eYd6F",
	"overlayHide": "timKiem_overlayHide__NLGOP"
};
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/eriegin/workplace/P_Anmani/src/app/(site)/tim-kiem/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,8308,8300,5776,6154,8994,9892], () => (__webpack_exec__(90007)));
