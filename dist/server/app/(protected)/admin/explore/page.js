...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 13769)), "/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/explore/page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87393)), "/home/eriegin/workplace/P_Anmani/src/app/error.tsx"],
    ...
    const pages = ["/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/explore/page.tsx"];
    ...
    const originalPathname = "/(protected)/admin/explore/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 65650))
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ AdminExplorePage)
});
...
var explore = __webpack_require__(87331);
...
;// CONCATENATED MODULE: ./src/app/(protected)/admin/explore/_components/ExploreTable/index.tsx
...
function ExploreTable() {
    ...
    const { data, isLoading } = (0,useGetExplores/* useGetExplores */.r)();
    const { trigger } = (0,explore/* useDeleteExplore */.mb)();
    const { showMDeleteConfirmationModal } = (0,ModalProvider/* useModalContext */.vR)();
    const handleDelete = (exploreId)=>{
    ...
    const columns = (0,react_.useMemo)(()=>[
            {
                ...
                render: (title, { id })=>/*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                        href: `${route/* ROUTE */.ln.ADMIN_EXPLORE}/${id}`,
                        children: title
                    })
            },
            {
                title: "Link h\xecnh ảnh/video ch\xednh",
                dataIndex: "url",
                ...getColumnSearchProps("url"),
                render: (url)=>/*#__PURE__*/ jsx_runtime_.jsx("a", {
                        href: url,
                        target: "_black",
                        rel: "noreferer",
                        children: url
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(lib/* Table */.iA, {
        columns: columns,
        dataSource: data && mock_data/* exploreVideoList */.Tq,
        pagination: {
            current: 1,
            pageSize: 10
        },
...
;// CONCATENATED MODULE: ./src/app/(protected)/admin/explore/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                    href: route/* ROUTE */.ln.ADMIN_EXPLORE_CREATE,
                    children: /*#__PURE__*/ jsx_runtime_.jsx(lib/* Button */.zx, {
                        type: "primary",
                        children: "Tạo Kh\xe1m ph\xe1"
                    })
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                children: /*#__PURE__*/ jsx_runtime_.jsx(ExploreTable, {})
            })
        ]
    });
}
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/explore/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,8308,5776,2735,7331], () => (__webpack_exec__(94472)));
