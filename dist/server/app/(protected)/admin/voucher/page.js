...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 412)), "/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/voucher/page.tsx"],
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87393)), "/home/eriegin/workplace/P_Anmani/src/app/error.tsx"],
    ...
    const pages = ["/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/voucher/page.tsx"];
    ...
    const originalPathname = "/(protected)/admin/voucher/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 59870))
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ AdminVoucherPage)
});
...
;// CONCATENATED MODULE: ./src/app/(protected)/admin/voucher/_components/VoucherTable/index.tsx
...
function VoucherTable() {
    const searchInput = (0,react_.useRef)(null);
    const { data, isLoading } = (0,useGetVouchers/* useGetVouchers */.M)();
    const { trigger } = (0,voucher/* useDeleteVoucher */.bg)();
    const { showMDeleteConfirmationModal } = (0,ModalProvider/* useModalContext */.vR)();
    ...
    const handleSearch = (confirm, close)=>{
        confirm();
        close();
    };
    ...
    const getColumnSearchProps = (0,react_.useCallback)((dataIndex)=>({
            filterDropdown: ({ setSelectedKeys, selectedKeys, confirm, clearFilters, close })=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    style: {
                        padding: 8
                    },
    ...
    const columns = (0,react_.useMemo)(()=>[
            {
                title: "Voucher ID",
                dataIndex: "id",
                ...
                render: (id)=>/*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                        href: `${route/* ROUTE */.ln.ADMIN_VOUCHER}/${id}`,
                        children: id
                    })
            },
            {
                ...
                onFilter: (value, record)=>record.productId.indexOf(value.toString()) === 0,
                ...
                render: (productId)=>{
                    const name = mock_data/* productList */.Uu.find((product)=>product.id === productId)?.name;
                    return /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                        href: `${route/* ROUTE */.ln.ADMIN_PRODUCT}/${productId}`,
                        children: name
                    });
                }
            },
            {
                ...
                onFilter: (value, record)=>record.productId.indexOf(value.toString()) === 0,
                sorter: (a, b)=>{
                    const aPrice = mock_data/* productList */.Uu.find((product)=>product.id === a.productId)?.price;
                    const bPrice = mock_data/* productList */.Uu.find((product)=>product.id === b.productId)?.price;
                ...
                render: (productId)=>{
                    const price = mock_data/* productList */.Uu.find((product)=>product.id === productId)?.price;
                    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
                        children: (0,formatCurrency/* formatCurrency */.x)(price, true, true)
                    });
                }
            },
            {
                ...
                render: (discount)=>/*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
                        children: discount?.amount ? (0,formatCurrency/* formatCurrency */.x)(discount?.amount) : `${discount?.percent}%`
                    })
            },
            {
                title: "Điều kiện",
            ...
            },
            {
                title: "X\xf3a",
                dataIndex: "action",
                render: (_, { id })=>/*#__PURE__*/ jsx_runtime_.jsx(lib/* Button */.zx, {
                        danger: true,
                        shape: "circle",
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(lib/* Table */.iA, {
        columns: columns,
        dataSource: data && mock_data/* voucherList */.Co,
        pagination: {
            current: 1,
            pageSize: 10
        },
...
// EXTERNAL MODULE: ./src/app/(protected)/admin/_shared/page.module.scss
var page_module = __webpack_require__(88404);
var page_module_default = /*#__PURE__*/__webpack_require__.n(page_module);
;// CONCATENATED MODULE: ./src/app/(protected)/admin/voucher/page.tsx
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: (page_module_default()).actionWrapper,
                children: /*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                    href: route/* ROUTE */.ln.ADMIN_VOUCHER_CREATE,
                    children: /*#__PURE__*/ jsx_runtime_.jsx(lib/* Button */.zx, {
                        type: "primary",
                        children: "Tạo Voucher"
                    })
                })
            }),
            /*#__PURE__*/ jsx_runtime_.jsx(VoucherTable, {})
        ]
    });
}
...
// Exports
module.exports = {
	"actionWrapper": "page_actionWrapper__jqjLQ",
	"overlayShow": "page_overlayShow__1F_xc",
	"overlayHide": "page_overlayHide__LE8mr"
};
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/voucher/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,8308,5776,2735,9618], () => (__webpack_exec__(35621)));
