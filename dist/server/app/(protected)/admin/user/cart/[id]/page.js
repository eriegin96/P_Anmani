...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 26102)), "/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/user/cart/[id]/page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 13249)), "/home/eriegin/workplace/P_Anmani/src/app/(protected)/layout.tsx"],
          metadata: {
...
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87393)), "/home/eriegin/workplace/P_Anmani/src/app/error.tsx"],
    ...
    const pages = ["/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/user/cart/[id]/page.tsx"];
    ...
    const originalPathname = "/(protected)/admin/user/cart/[id]/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 15483))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AdminUserCartPage)
/* harmony export */ });
...
/* harmony import */ var _id_module_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(42317);
/* harmony import */ var _id_module_scss__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_id_module_scss__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _utils_formatCurrency__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(28970);
/* harmony import */ var _hooks_api_cart_query_useGetCartById__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(60300);
/* harmony import */ var _app_site_loading__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(56298);
...
function AdminUserCartPage({ params: { id } }) {
    const { data, isLoading } = (0,_hooks_api_cart_query_useGetCartById__WEBPACK_IMPORTED_MODULE_2__/* .useGetCartById */ .L)(id);
    const { bookingInfo: { userId, phoneNumber, date, place }, cartList } = _mock_data__WEBPACK_IMPORTED_MODULE_1__/* .userCartList */ .gI.find((cart)=>cart.id === id);
    const userName = _mock_data__WEBPACK_IMPORTED_MODULE_1__/* .userList */ .Lh.find((user)=>user.id === userId)?.name;
    const cartProductList = cartList.map((cartItem)=>({
            key: cartItem.id,
            product: _mock_data__WEBPACK_IMPORTED_MODULE_1__/* .productList */ .Uu.find((product)=>product.id === cartItem.productId),
            voucherList: _mock_data__WEBPACK_IMPORTED_MODULE_1__/* .voucherList */ .Co.filter((voucher)=>cartItem.voucherAdded.includes(voucher.id))
        }));
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            isLoading && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_app_site_loading__WEBPACK_IMPORTED_MODULE_3__["default"], {}),
            data && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_4__/* .Descriptions */ .w5, {
                        title: "Th\xf4ng tin kh\xe1ch h\xe0ng",
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_4__/* .Descriptions */ .w5.Item, {
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(Title, {
                        level: 4,
                        children: "Th\xf4ng tin giỏ h\xe0ng"
                    }),
                    cartProductList.map(({ key, product: { name, price, location: { detail } }, voucherList }, index)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_4__/* .Descriptions */ .w5, {
                            title: `Sản phẩm ${index + 1}`,
                            bordered: true,
                            className: (_id_module_scss__WEBPACK_IMPORTED_MODULE_5___default().descriptions),
                            children: [
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_4__/* .Descriptions */ .w5.Item, {
                                ...
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_4__/* .Descriptions */ .w5.Item, {
                                    label: "Gi\xe1 tiền",
                                    children: (0,_utils_formatCurrency__WEBPACK_IMPORTED_MODULE_6__/* .formatCurrency */ .x)(price)
                                }),
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_4__/* .Descriptions */ .w5.Item, {
                                    label: "Vị tr\xed",
                                    children: detail
                                ...
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(antd__WEBPACK_IMPORTED_MODULE_4__/* .Descriptions */ .w5.Item, {
                                    label: "Voucher \xe1p dụng",
                                    children: voucherList.map(({ id, discount, discountOption, condition })=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("li", {
                                            children: [
                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                                    children: discountOption === "amount" ? (0,_utils_formatCurrency__WEBPACK_IMPORTED_MODULE_6__/* .formatCurrency */ .x)(discount.amount) : `${discount.percent}%`
                                                }),
                                                " ",
                                                "- ",
                                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
...
// Exports
module.exports = {
	"descriptions": "_id__descriptions__blDZL",
	"overlayShow": "_id__overlayShow__9Ovj4",
	"overlayHide": "_id__overlayHide__qQCnz"
};
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/eriegin/workplace/P_Anmani/src/app/(protected)/admin/user/cart/[id]/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,8308,5776,2735], () => (__webpack_exec__(42744)));
